...
{
  if (argc < 2) {
          std::cerr << "Usage: Put a parameter after ./poke327 namely pokemon, moves, pokemon_moves, pokemon_species, experience, type_names, pokemon_stats, stats or pokemon_types" << std::endl;
          return 1; 
      }
  struct timeval tv;
  uint32_t seed;
